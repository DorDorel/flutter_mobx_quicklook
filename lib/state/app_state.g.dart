...
mixin _$AppState on _AppState, Store {
  ...
  @override
  Future<bool> modify({required Reminder reminder, required bool isDone}) {
    return _$modifyAsyncAction
        .run(() => super.modify(reminder: reminder, isDone: isDone));
  }
  ...
  @override
  Future<bool> register({required dynamic email, required String password}) {
    final _$actionInfo =
  ...
  @override
  Future<bool> login({required dynamic email, required String password}) {
    final _$actionInfo =
